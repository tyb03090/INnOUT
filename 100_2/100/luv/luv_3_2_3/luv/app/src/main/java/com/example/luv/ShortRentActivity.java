...
public class ShortRentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView  mLockerNumberTextView= findViewById(R.id.textview24);
        ...
        calendarImageStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShortRentActivity.this, DateTimeActivity.class);
        ...
        calendarImageEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShortRentActivity.this, DateTimeActivity2.class);
        ...
        reserveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 예약 시작일이 예약 종료일보다 이후인 경우
                if (!isStartDateBeforeEndDate(startDate, endDate)) {
                    Toast.makeText(ShortRentActivity.this, "예약 시작일은 예약 종료일보다 이전이어야 합니다.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void onClickReserve(View view) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // 예약 내역 화면으로 이동
                Intent intent = new Intent(ShortRentActivity.this, ReservationsActivity.class);
                intent.putExtra("fontNumber", mTag);
                intent.putExtra("lockerNumber", mLockerNumber);
